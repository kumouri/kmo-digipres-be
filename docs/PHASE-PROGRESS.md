...
| H.4 Postmark bounce/spam routing (in-place) | in-progress |  |  | switchIfEmpty grep; PostmarkAuthVerifier empty diff; reuse EMAIL_BOUNCED/EMAIL_SPAM, no new event/controller | |
