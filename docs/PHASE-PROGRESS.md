...
| H.3 IMAP inbound poll-source → unchanged InboundEmailService | in-progress |  |  | switchIfEmpty grep; default-OFF; Message-ID idempotent; InboundEmailService empty diff | |
